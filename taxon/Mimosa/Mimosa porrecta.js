...
exports.Mimosa_porrecta = void 0;
// Import genus Mimosa
var _1 = require(".");
// Import characters
...
var Mimosa_porrecta = new _1.Mimosa();
exports.Mimosa_porrecta = Mimosa_porrecta;
Mimosa_porrecta.specificEpithet = 'porrecta';
Mimosa_porrecta.habit = 'shrub';
Mimosa_porrecta.stems = new v1_1.Stems();
Mimosa_porrecta.stems.orientation = 'scandent';
Mimosa_porrecta.stems.shape = 'cylindric';
Mimosa_porrecta.stems.trichomes = new v1_1.Trichomes;
Mimosa_porrecta.stems.trichomes.filiform = new Trichomes_1.Filiform();
Mimosa_porrecta.stems.trichomes.filiform.are = 'present';
Mimosa_porrecta.stems.trichomes.porrect = new Trichomes_1.Porrect();
Mimosa_porrecta.stems.trichomes.porrect.are = 'present';
Mimosa_porrecta.stems.trichomes.granular = new Trichomes_1.Granular();
Mimosa_porrecta.stems.trichomes.granular.are = 'present';
Mimosa_porrecta.stems.prickles = new v1_1.Prickles();
Mimosa_porrecta.stems.prickles.orientation = 'decurved';
Mimosa_porrecta.stipule = new v1_1.Stipule();
...
Mimosa_porrecta.stipule.margin = new Stipule_1.MarginStipule();
Mimosa_porrecta.stipule.margin.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.stipule.margin.trichomes.setiform = new Trichomes_1.Setiform();
...
Mimosa_porrecta.stipule.adaxial = new Stipule_1.AdaxialStipule();
Mimosa_porrecta.stipule.adaxial.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.stipule.adaxial.trichomes.filiform = new Trichomes_1.Filiform();
Mimosa_porrecta.stipule.adaxial.trichomes.filiform.are = 'present';
Mimosa_porrecta.stipule.abaxial = new Stipule_1.AbaxialStipule();
Mimosa_porrecta.stipule.abaxial.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.stipule.abaxial.trichomes.setiform = new Trichomes_1.Setiform();
...
Mimosa_porrecta.stipule.abaxial.trichomes.filiform = new Trichomes_1.Filiform();
Mimosa_porrecta.stipule.abaxial.trichomes.filiform.are = 'present';
Mimosa_porrecta.stipule.abaxial.trichomes.granular = new Trichomes_1.Granular();
Mimosa_porrecta.stipule.abaxial.trichomes.granular.are = 'present';
Mimosa_porrecta.stipule.nervation = ['1-nerved', '3-nerved'];
Mimosa_porrecta.leaf = new v1_1.Leaf();
Mimosa_porrecta.leaf.petiole = new Leaf_1.Petiole();
Mimosa_porrecta.leaf.petiole.setLengthMinMax(25, 83);
Mimosa_porrecta.leaf.petiole.prickles = new v1_1.Prickles();
Mimosa_porrecta.leaf.petiole.prickles.orientation = 'decurved';
Mimosa_porrecta.leaf.bipinnate = new Leaf_1.Bipinnate();
Mimosa_porrecta.leaf.bipinnate.pinnae = new Bipinnate_1.Pinnae();
Mimosa_porrecta.leaf.bipinnate.pinnae.paraphillidia = new Pinnae_1.Paraphillidia();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.prickles = new v1_1.Prickles();
Mimosa_porrecta.leaf.bipinnate.pinnae.prickles.orientation = 'decurved';
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet = new Pinnae_1.Leaflet();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.margin = new Leaflet_1.MarginLeaflet();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.margin.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.margin.trichomes.setiform = new Trichomes_1.Setiform();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.adaxial = new Leaflet_1.AdaxialLeaflet();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.adaxial.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.adaxial.trichomes.filiform = new Trichomes_1.Filiform();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial = new Leaflet_1.AbaxialLeaflet();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial.trichomes.porrect = new Trichomes_1.Porrect();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial.trichomes.granular = new Trichomes_1.Granular();
...
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial.trichomes.filiform = new Trichomes_1.Filiform();
Mimosa_porrecta.leaf.bipinnate.pinnae.leaflet.abaxial.trichomes.filiform.are = 'present';
Mimosa_porrecta.inflorescence = new v1_1.Inflorescence();
Mimosa_porrecta.inflorescence.shape = 'moriform';
Mimosa_porrecta.inflorescence.capitate = new Inflorescence_1.CapitateInflorescence();
Mimosa_porrecta.inflorescence.capitate.shape = 'globose';
Mimosa_porrecta.inflorescence.peduncle = new Inflorescence_1.Peduncle();
Mimosa_porrecta.inflorescence.peduncle.setLengthMinMax(10, 27);
Mimosa_porrecta.flower = new v1_1.Flower();
Mimosa_porrecta.flower.bracteole = new Flower_1.Bracteole();
Mimosa_porrecta.flower.bracteole.setLengthMinMax(1.2, 1.5);
Mimosa_porrecta.flower.bracteole.apex = new Bracteole_1.ApexBracteole();
Mimosa_porrecta.flower.bracteole.apex.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.flower.bracteole.apex.trichomes.setiform = new Trichomes_1.Setiform();
...
Mimosa_porrecta.flower.calyx = new Flower_1.Calyx();
Mimosa_porrecta.flower.calyx.setLengthMinMax(1.5, 2);
Mimosa_porrecta.flower.calyx.shape = 'pappiform';
Mimosa_porrecta.flower.corolla = new Flower_1.Corolla();
Mimosa_porrecta.flower.corolla.setLengthMinMax(1.8, 2.1);
Mimosa_porrecta.flower.corolla.shape = ['tubulose', 'campanulate'];
Mimosa_porrecta.flower.corolla.lobes = new Corolla_1.Lobes();
Mimosa_porrecta.flower.corolla.lobes.nervation = '1-nerved';
Mimosa_porrecta.flower.corolla.lobes.apex = new Lobes_1.ApexLobes();
Mimosa_porrecta.flower.corolla.lobes.apex.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.flower.corolla.lobes.apex.trichomes.filiform = new Trichomes_1.Filiform();
Mimosa_porrecta.flower.corolla.lobes.apex.trichomes.filiform.are = 'present';
Mimosa_porrecta.androecium = new v1_1.Androecium();
Mimosa_porrecta.androecium.filaments = new Androecium_1.Filaments();
Mimosa_porrecta.androecium.filaments.colour = 'pinkish';
Mimosa_porrecta.ginoecium = new v1_1.Ginoecium();
Mimosa_porrecta.ginoecium.ovary = new Ginoecium_1.Ovary();
Mimosa_porrecta.pollen = new v1_1.Pollen();
Mimosa_porrecta.pollen.type = 'tetrad';
Mimosa_porrecta.pollen.format = 'tetraedric';
Mimosa_porrecta.pollen.exine = 'areolate';
Mimosa_porrecta.fruit = new v1_1.Fruit();
...
Mimosa_porrecta.fruit.stipe = new Fruit_1.Stipe();
Mimosa_porrecta.fruit.stipe.is = 'absent';
Mimosa_porrecta.fruit.replum = new Fruit_1.Replum();
Mimosa_porrecta.fruit.replum.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.fruit.replum.trichomes.dendritic = new Trichomes_1.Dendritic();
...
Mimosa_porrecta.fruit.epicarp = new Fruit_1.Epicarp();
Mimosa_porrecta.fruit.epicarp.type = 'monospermic';
Mimosa_porrecta.fruit.epicarp.trichomes = new v1_1.Trichomes();
Mimosa_porrecta.fruit.epicarp.trichomes.porrect = new Trichomes_1.Porrect();
...
Mimosa_porrecta.fruit.epicarp.trichomes.filiform = new Trichomes_1.Filiform();
...
Mimosa_porrecta.seed = new v1_1.Seed();
...
Mimosa_porrecta.descriptionAuthorship = new v1_2.DescriptionAuthorship();
